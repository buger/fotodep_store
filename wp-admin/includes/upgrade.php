...
function wp_install_defaults($user_id) {
	...
	$default_links[] = array(	'link_url' => 'http://plugins.mywordpress.ru/',
								'link_name' => 'Плагины',
								'link_rss' => '',
								'link_notes' =>'');

	$default_links[] = array(	'link_url' => 'http://themes.mywordpress.ru/',
								'link_name' => 'Темы оформления',
								'link_rss' => '',
								'link_notes' =>'');
...
As a new WordPress user, you should go to <a href=\"%s\">your dashboard</a> to delete this page and create new pages for your content. Have fun!" ), admin_url() );
  ...
  // Russian helper plugin activation
	$plugin  = plugin_basename( trim( 'rh/rh.php' ) );
	if ( is_multisite() ) {
